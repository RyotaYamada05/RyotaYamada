...
public:
	...
	static CBullet*Create(const D3DXVECTOR3 pos, const D3DXVECTOR3 move, const D3DXVECTOR3 size, const D3DXCOLOR col,
		const BULLET_USER bulletUser, const BULLET_TYPE bulletType, int nAtk, int nLife = BULLET_LIFE);
	static HRESULT Load(void);
	static void UnLoad(void);

	virtual HRESULT Init(const D3DXVECTOR3 pos, const D3DXVECTOR3 move, const D3DXVECTOR3 size, const D3DXCOLOR col,
...
private:
	...
	BULLET_USER m_bulletUser;	//バレットの使用者
