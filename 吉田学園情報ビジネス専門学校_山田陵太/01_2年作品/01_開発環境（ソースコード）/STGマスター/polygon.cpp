...
HRESULT CPolygon::Load(void)
{
	...
	D3DXCreateTextureFromFile(pD3DDevice, "data/Texture/UI/チーター.png", &m_pTexture[TEX_TYPE_CHEETAH]);	//チーター
	D3DXCreateTextureFromFile(pD3DDevice, "data/Texture/UI/ゴリラ.png", &m_pTexture[TEX_TYPE_GORILLA]);	//ゴリラ
	D3DXCreateTextureFromFile(pD3DDevice, "data/Texture/UI/亀.png", &m_pTexture[TEX_TYPE_TURTLE]);	//カメ
