...
HRESULT CEnemy::Load(void)
{
	...
	D3DXCreateTextureFromFile(pD3DDevice, "data/Texture/enemy/Enemy_Turtle.png", &m_pTexture[ENEMY_TYPE_HADE]);
	D3DXCreateTextureFromFile(pD3DDevice, "data/Texture/enemy/Enemy_Gorilla.png", &m_pTexture[ENEMY_TYPE_DIVISION]);
	D3DXCreateTextureFromFile(pD3DDevice, "data/Texture/enemy/Enemy_Cheetah.png", &m_pTexture[ENEMY_TYPE_STOKER]);
...
//=============================================================================
//エネミークラスのホーミングタイプの更新処理
//=============================================================================
void CEnemy::HomingUpdate(void)
{
	//プレイヤーの位置情報を取得
	D3DXVECTOR3 Playerpos = CGame::GetPlayer()->GetPos();
	...
	if (m_nCounter % 80 == 0 && m_pos.x >= Playerpos.x)
	{
		...
		//バレットの生成
		CBullet::Create(m_pos, move, BULLET_SIZE, COLOR_RED,
			CBullet::BULLET_USER_ENEMY, CBullet::BULLET_TYPE_HOMING, ATK_NORMAL);
	}
}
