...
public:
	...
	{
		Dead_Process_NOEN = 0,
		Dead_Process_LIFE,	//死亡時に回復アイテムを生成する
		Dead_Process_SKILL,	//死亡時にスキル回復アイテムを生成する
		Dead_Process_BOSS,	//死亡時にボスを生成する
	}Dead_Process;
	...
	typedef enum
	{
		...
		ACTION_PATTERN_STOP_RETURN,	//停止後帰還する
